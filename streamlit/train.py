...
def train_step(model: nn.Module,
    ...
    progress_bar = streamlit.StreamlitProgressBar(0, len(train_loader), desc="Train")
...
def eval_step(model: nn.Module,
    ...
    progress_bar = streamlit.StreamlitProgressBar(0, len(test_loader), desc="Test")
...
def train_model(model: nn.Module,
    ...
    progress_bar = streamlit.StreamlitProgressBar(start_epoch, epochs, desc=f"The model is training epoch {start_epoch+1}/{epochs}")
    
    for epoch in range(start_epoch, epochs):
        
        progress_bar.updateDescription(f"The model is training epoch {epoch+1}/{epochs}")
...
def train_progress(dataset_path: str,
    ...
    dataloader, image_datasets = dp.get_data_loaders(dataset_path, train_batch_size, eval_batch_size, num_workers)
